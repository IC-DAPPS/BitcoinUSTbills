...
{#if checking}
	<div class="min-h-screen flex items-center justify-center bg-background-main">
	...
	<div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 py-12">
		<div class="container mx-auto px-6 max-w-2xl">
			...
			<div class="text-center mb-8">
				<div
					class="w-16 h-16 bg-primary-blue rounded-xl flex items-center justify-center mx-auto mb-4"
				>
					<span class="text-white font-bold text-2xl">B</span>
				</div>
				<h1 class="text-3xl lg:text-4xl font-bold text-primary mb-4">Complete Your Registration</h1>
				<p class="text-lg text-secondary leading-relaxed">
					Welcome to BitcoinUSTbills! Please provide your information to start investing in US
					Treasury Bills.
				</p>
			</div>
				...
				>
					...
					<div>
						...
						<p class="mt-1 text-xs text-muted">
							Including your phone number helps us provide better support and account security.
						</p>
					</div>
			...
			<div class="mt-8 text-center">
				<p class="text-secondary text-sm">Need help? Contact our support team for assistance.</p>
			</div>
		</div>
	</div>
{/if}

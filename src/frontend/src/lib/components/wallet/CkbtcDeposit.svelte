...
<Button variant="primary" class="flex-1" onclick={() => (open = true)}
  >⬇ Deposit</Button
>
...
>
  ...
  <label
    for="principal-id"
    class="w-full border rounded-lg p-3 md:p-4 space-y-3"
  >
    ...
    <p class="text-xs text-gray-500">
      Use for all ICRC tokens when receiving from wallets, users, or other apps
      that support Principal ID.
    </p>
  </label>

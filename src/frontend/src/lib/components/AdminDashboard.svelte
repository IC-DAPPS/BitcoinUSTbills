...
<div class="space-y-6">
	<div class="flex justify-between items-center">
		...
		<Button variant="secondary" onclick={fetchStats} disabled={stats.loading}>Refresh Stats</Button>
	</div>
		...
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
			...
			<div class="card p-6">
				<div class="flex items-center justify-between">
					<div>
						<p class="text-sm font-medium text-secondary">Total OUSG Supply</p>
			...
			<div class="card p-6">
				<div class="flex items-center justify-between">
					<div>
						<p class="text-sm font-medium text-secondary">ckBTC Balance</p>
						<p class="text-2xl font-bold text-primary">
				...
				<p class="text-xs text-muted mt-2">Backend reserve balance</p>
			</div>
			...
			<div class="card p-6">
				<div class="flex items-center justify-between">
					<div>
						<p class="text-sm font-medium text-secondary">Total Mints</p>
						<p class="text-2xl font-bold text-primary">
							{stats.totalMints}
						</p>
					</div>
				...
				<p class="text-xs text-muted mt-2">Successful minting transactions</p>
			</div>
			...
			<div class="card p-6">
				<div class="flex items-center justify-between">
					<div>
						<p class="text-sm font-medium text-secondary">Total Redeems</p>
						<p class="text-2xl font-bold text-primary">
							{stats.totalRedeems}
						</p>
					</div>
				...
				<p class="text-xs text-muted mt-2">Successful redemption transactions</p>
			</div>
		</div>

		<!-- Additional Admin Actions -->
		<div class="card p-6">
			<h3 class="text-lg font-semibold text-primary mb-4">Admin Actions</h3>
			<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
				<Button variant="outline" href="/admin/kyc" class="w-full">Manage KYC Applications</Button>
